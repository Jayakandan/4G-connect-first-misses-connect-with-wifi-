...
public:
  ...
  // Public methods to access input buffer
  String getInputBuffer() { return inputBuffer; }
  void clearInputBuffer() { inputBuffer = ""; }
  bool hasNewInput() { return newInputReady; }
  void clearNewInputFlag() { newInputReady = false; }
  String getLastInput() { return lastInput; }
...
private:
  ...
  char hidKeycodeToChar(uint8_t keycode, bool shift);
